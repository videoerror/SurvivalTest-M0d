...
namespace ClassicalSharp.Survival.UI {
	...
	internal sealed class GenerateNewLevelScreen : MenuOptionsScreen {
		...
		public override void Render(double delta) {
			// Moves the game over text by using the needed new X value as the game width value divided by two
			// minus the generate new level text's width value divided by two and the new Y value as the small title's Y value
			// minus the generate new level text's height value minus the small title button elements's height value divided by two.
